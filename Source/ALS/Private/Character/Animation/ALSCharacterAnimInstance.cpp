...
void UALSCharacterAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	CharacterInformation.bIsTurnLookingDirection = Character->IsTurnLookingDirection();
...
bool UALSCharacterAnimInstance::CanRotateInPlace() const
{
	return CharacterInformation.RotationMode == EALSRotationMode::Aiming ||
		CharacterInformation.ViewMode == EALSViewMode::FirstPerson || CharacterInformation.RotationMode == EALSRotationMode::Combat;
}

bool UALSCharacterAnimInstance::CanTurnInPlace() const
{
	if (CharacterInformation.bIsTurnLookingDirection)
	{
