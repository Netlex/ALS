...
public:
	...
	UFUNCTION(BlueprintGetter, Category = "Rotation System")
	bool IsTurnLookingDirection() const { return bIsTurnLookingDirection; }
	...
	UFUNCTION(BlueprintPure, Category = "Essential Information")
	bool CanUseAiming();
...
protected:
	...
	bool IsSupportOverlayStateAiming(EALSOverlayState LocalOverlayState);
...
protected:
	...
	bool bIsTurnLookingDirection = true;
